...
\subsection{Value of tutorials}\label{sec:tutorial-value}
...
\subsection{Importance of communication skills}\label{sec:comm-value}
...
\subsection{Linking communication skills}\label{sec:talk-essay}
